...
try {
    for (var ChampionsLegal_1 = __values(ChampionsLegal), ChampionsLegal_1_1 = ChampionsLegal_1.next(); !ChampionsLegal_1_1.done; ChampionsLegal_1_1 = ChampionsLegal_1.next()) {
        var pokemon = ChampionsLegal_1_1.value;
    ...
    try {
        if (ChampionsLegal_1_1 && !ChampionsLegal_1_1.done && (_a = ChampionsLegal_1["return"])) _a.call(ChampionsLegal_1);
    }
...
try {
    ...
    try {
        if (SPECIES_1_1 && !SPECIES_1_1.done && (_b = SPECIES_1["return"])) _b.call(SPECIES_1);
    }
